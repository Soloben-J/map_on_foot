...
import 'package:map_on_foot/DemoPages/search/other_search/show_aoi_search_page.dart';
import 'package:map_on_foot/DemoPages/search/other_search/show_buildingpsearch_page.dart';
import 'package:map_on_foot/DemoPages/search/other_search/show_busline_search_page.dart';
import 'package:map_on_foot/DemoPages/search/other_search/show_district_search_page.dart';
import 'package:map_on_foot/DemoPages/search/other_search/show_geocode_search_page.dart';
import 'package:map_on_foot/DemoPages/search/other_search/show_reversegeocode_search_page.dart';
import 'package:map_on_foot/DemoPages/search/other_search/show_weather_search_page.dart';
import 'package:map_on_foot/DemoPages/search/other_search/show_recommend_stop_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(child: ListView(children: [
        FunctionItem(
          label: 'AOI检索',
          sublabel: 'show_aoi_search_page',
          target: ShowAOISearchPage(),
        ),
        FunctionItem(
          label: 'POI城市内检索',
