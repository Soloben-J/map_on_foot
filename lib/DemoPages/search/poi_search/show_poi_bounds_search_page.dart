...
import 'package:map_on_foot/DemoPages/search/poi_search_params/show_poi_bounds_search_params_page.dart';
...
class _ShowPOIBoundsSearchPageState
  ...
  void _onTapSearch() async {
    ...
    if (_boundSearchOption != null) {
      ...
      option.extensionsAdcode = _boundSearchOption?.extensionsAdcode;
