...
import 'package:map_on_foot/CustomWidgets/input_box.dart';
import 'package:map_on_foot/CustomWidgets/search_btn.dart';
import 'package:map_on_foot/DemoPages/search/poi_search_params/show_poi_nearby_search_params_page.dart';
...
class _ShowPOINearbySearchPageState
  ...
  void _onTapSearch() async {
    ...
    if (_nearbySearchOption != null) {
      ...
      option.extensionsAdcode = _nearbySearchOption?.extensionsAdcode;
    }
