...
import 'package:map_on_foot/DemoPages/search/poi_search_params/show_poi_detail_search_params_page.dart';
...
class _ShowPOIDetailSearchPageState
  ...
  void _onTapSearch() async {
    ...
    if (_detailSearchOption != null) {
      ...
      option.extensionsAdcode = _detailSearchOption!.extensionsAdcode;
    }
