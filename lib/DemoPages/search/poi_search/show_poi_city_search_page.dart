...
import 'package:map_on_foot/DemoPages/search/poi_search_params/show_poi_city_search_params_page.dart';
...
class _ShowPOICitySearchPageState
  ...
  void _onTapSearch() async {
    ...
    if (_citySearchOption != null) {
      ...
      citySearchOption.extensionsAdcode = _citySearchOption?.extensionsAdcode;
    }
