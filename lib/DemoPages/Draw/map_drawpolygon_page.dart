...
import 'package:map_on_foot/CustomWidgets/map_raised_button.dart';
...
class _DrawPolygonPageState extends BMFBaseMapState<DrawPolygonPage> {
  ...
  void onBMFMapCreated(BMFMapController controller) {
    ...
    controller.setMapOnClickedOverlayCallback(callback: (BMFOverlay polygon) {
      print('地图点击覆盖物回调，polygon=${polygon.toMap()}');
      showToast(context, "polygon");
    });
  }
